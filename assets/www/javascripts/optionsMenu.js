var OptionsMenu = function(menu) {
    ...
    for (i in menu.items) {
        ...
        for (j in menu.items[i]) {
            ...
            menuItem.setAttribute("style", "color: white; font-weight: bold; border-top: 1px solid grey; border-right: 1px solid grey; background-color: black; -webkit-tap-highlight-color: rgba(255, 255, 255, 0);");
